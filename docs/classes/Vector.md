...
Defined in: [lib/vector.ts:24](https://github.com/satisfactory-dev/lunr.js/blob/bcf37e1c4ac8bbdd8e47233952de7f825c704852/lib/vector.ts#L24)
...
> **new Vector**\<`Odd`, `Elements`\>(`positions`, `elements?`): `Vector`\<`Odd`, `Elements`\>
